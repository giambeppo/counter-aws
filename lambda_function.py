...
def respond(err, statusCode, res=None):
  print(res)
...
def set(with_function, counter, value):
  try:
    item = with_function(counter, value)
  ...
  if 'after' in params:
    ...
    if after == 'increment':
      ...
      if 'newValue' in params:
        ...
        return set(db_update, counter, value)
      else:
...
def lambda_handler(event, context):
  ...
  if operation in operations:
    ...
    return respond(f'Unsupported method "{operation}"', statusCode=400)
